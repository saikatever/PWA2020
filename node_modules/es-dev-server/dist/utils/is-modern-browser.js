 ...
 */
const modernBrowsers = ['last 2 Chrome major versions', 'unreleased Chrome versions', 'last 2 ChromeAndroid major versions', 'unreleased ChromeAndroid versions', 'last 2 Edge major versions', 'unreleased Edge versions', 'last 2 Firefox major versions', 'unreleased Firefox versions', 'last 2 FirefoxAndroid major versions', 'unreleased FirefoxAndroid versions', 'last 1 Safari versions', 'last 1 iOS versions' // unreleased safari throws an error
...
const unimplementedFeatures = [// <= does properly match, so we list the latest 2 versions which doesn't support it,
// the rest will be filtered by the other check
'Chrome 78', 'Chrome 79', 'ChromeAndroid 78', 'ChromeAndroid 79', // (edge 78 does not exist)
'Edge 79', 'Firefox 72', 'Firefox 73', 'FirefoxAndroid 72', 'FirefoxAndroid 73', 'Safari 12', 'Safari 12.1', 'Safari 13', 'iOS 12', 'iOS 12.1', 'iOS 13'];
/**
...
function isModernBrowser(userAgent) {
  if ((0, _browserslistUseragent.matchesUA)(userAgent, {
    browsers: unimplementedFeatures
  })) {
    (0, _utils.logDebug)(`Forcing compatibility mode on user agent ${userAgent} because it does not` + ' implement all standard stage 4 features.');
    return false;
  }

  return (0, _browserslistUseragent.matchesUA)(userAgent, {
